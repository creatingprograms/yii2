...
class StoreProductSearch extends StoreProduct
{
    ...
    public function rules()
    {
        return [
            ...
            [['sku', 'title', 'slug', 'price', 'discount_price', 'discount', 'short_description', 'description', 'status', 'imageFile', 'allFile', 'meta_title', 'meta_keywords', 'meta_description', 'position', 'create_time', 'update_time', 'attribute'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'sku', $this->sku])
            ->andFilterWhere(['like', 'store_attribute.string_value', $this->attribute])
